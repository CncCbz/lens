...
本项目基于 [dyedd/lens](https://github.com/dyedd/lens) 继续开发，原项目采用 MIT License。
...
访问 `http://127.0.0.1:8318`，使用 `.env` 中配置的管理员账号登录；`LENS_ADMIN_USERNAME` 默认为 `admin`。
...
本项目基于 [dyedd/lens](https://github.com/dyedd/lens) 继续开发。原项目及本项目代码均按 [MIT License](./LICENSE) 发布，第三方声明见 [THIRD_PARTY_NOTICES.md](./THIRD_PARTY_NOTICES.md)。
