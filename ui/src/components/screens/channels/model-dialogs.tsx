...
function prettyTestContent(content?: string | null): string {
  if (!content) return "";
  try {
                ...
                <div className="grid gap-4">
                  ...
                  {modelTestResult ? (
                    ...
                    >
                      ...
                      <div
                        className={cn(
                          "max-h-44 overflow-y-auto border-b px-3 py-2 whitespace-pre-wrap break-words text-sm",
                          modelTestResult.success
                            ? "text-foreground"
                            : "text-destructive",
                        )}
                      ...
                      <Tabs defaultValue="headers">
                        <TabsList className="h-auto w-full justify-start gap-0 rounded-none border-b bg-transparent p-0">
                          {(
                            [
                              ["headers", "上游请求头", "Upstream headers"],
                              [
                                "response-headers",
                                "上游响应头",
                        ...
                        <TabsContent value="headers" className="mt-0">
                          <pre className="max-h-56 overflow-auto bg-background/60 px-3 py-2 font-mono text-[11px] leading-5 whitespace-pre-wrap break-all text-foreground">
                            {Object.keys(modelTestResult.upstream_headers ?? {})
                              .length
                              ? JSON.stringify(
                                  modelTestResult.upstream_headers,
                                  null,
                                  2,
                                )
                              : locale === "zh-CN"
                        ...
                        <TabsContent value="response-headers" className="mt-0">
                          <pre className="max-h-56 overflow-auto bg-background/60 px-3 py-2 font-mono text-[11px] leading-5 whitespace-pre-wrap break-all text-foreground">
                            {Object.keys(
                              modelTestResult.upstream_response_headers ?? {},
                            ).length
                              ? JSON.stringify(
                                  modelTestResult.upstream_response_headers,
                                  null,
                              ...
                              : locale === "zh-CN"
                                ? "无上游响应头"
                                : "No upstream response headers"}
                          </pre>
                        </TabsContent>
                        <TabsContent value="request" className="mt-0">
                          <pre className="max-h-56 overflow-auto bg-background/60 px-3 py-2 font-mono text-[11px] leading-5 whitespace-pre-wrap break-all text-foreground">
                            {prettyTestContent(
                              modelTestResult.request_content,
                            ) ||
                              (locale === "zh-CN"
                                ? "无请求内容"
                                : "No request content")}
                        ...
                        <TabsContent value="response" className="mt-0">
                          <pre className="max-h-56 overflow-auto bg-background/60 px-3 py-2 font-mono text-[11px] leading-5 whitespace-pre-wrap break-all text-foreground">
                            {prettyTestContent(
                              modelTestResult.response_content,
                            ) ||
                              (locale === "zh-CN"
                                ? "无响应内容"
                                : "No response content")}
