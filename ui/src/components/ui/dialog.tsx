...
export function AppDialogContent({
  ...
  return (
    <DialogContent
      ...
      className={cn(
        "flex max-h-[92dvh] flex-col gap-3 overflow-hidden sm:max-h-[88vh]",
        className,
      )}
    >
      ...
      {footer ? (
        <div className="flex shrink-0 flex-col-reverse gap-2 border-t pt-3 sm:flex-row sm:justify-end sm:gap-3">
          {footer}
        </div>
      ) : null}
    </DialogContent>
