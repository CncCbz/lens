...
export type ConfigBackupOverviewChannelDailyStat = {
  date: string;
  channel_id: string;
  channel_name: string;
  requests: number;
...
export type ConfigBackupOverviewDimensionDailyStat = {
  date: string;
  ...
  first_token_latency_ms_sum: number;
  input_tokens: number;
  cache_read_input_tokens: number;
  cache_write_input_tokens: number;
  output_tokens: number;
...
export type ConfigBackupStatsSnapshot = {
  ...
  channel_daily: ConfigBackupOverviewChannelDailyStat[];
  dimension_daily: ConfigBackupOverviewDimensionDailyStat[];
};
...
export type RouteSnapshot = {
  routes: Array<{
    ...
    open_channel_ids: string[];
    probe_channel_ids: string[];
  }>;
  health: Array<{
    channel_id: string;
    state: string;
...
export type OverviewChannelMetricPoint = {
  channel_id: string;
  channel_name: string;
  requests: number;
  total_tokens: number;
...
export type OverviewChannelTrendPoint = {
  date: string;
  channel_id: string;
  channel_name: string;
  value: number;
...
export type OverviewChannelAnalytics = {
  distribution: OverviewChannelMetricPoint[];
  trend: OverviewChannelTrendPoint[];
  available_channels: string[];
};

export type OverviewChannelHealthPoint = {
  channel_id: string;
  channel_name: string;
  request_count: number;
  successful_requests: number;
...
export type OverviewModelChannelUsagePoint = {
  id: string;
  name: string;
  request_count: number;
  successful_requests: number;
...
export type OverviewDimensionUsagePoint = {
  id: string;
  name: string;
  request_count: number;
  successful_requests: number;
  ...
  total_cost_usd: number;
  average_latency_ms: number;
  channel_items: OverviewModelChannelUsagePoint[];
};

export type OverviewDimensionTrendPoint = {
  date: string;
  id: string;
  name: string;
  request_count: number;
...
export type OverviewDimensionUsageAnalytics = {
  dimension_type: string;
  items: OverviewDimensionUsagePoint[];
  trend: OverviewDimensionTrendPoint[];
};
...
export type OverviewPerformanceTrendPoint = {
  date: string;
  id: string;
  name: string;
  request_count: number;
...
export type OverviewPerformanceAnalytics = {
  dimension_type: string;
  items: OverviewPerformancePoint[];
  trend: OverviewPerformanceTrendPoint[];
};
...
export type RequestLogLifecycleStatus =
  "connecting" | "streaming" | "succeeded" | "failed";
...
export type RequestLogAttempt = {
  ...
  cooldown_candidate?: boolean | null;
  user_actionable?: boolean | null;
  skip_retry?: boolean | null;
